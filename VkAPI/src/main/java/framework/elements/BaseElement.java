...
public abstract class BaseElement {
    ...
    public void hover() {
        Browser.getDriver().findElement(By.xpath(locator));
    }
    ...
    public String getElementTextInsideThisElement(String secondLocator) {
        return Browser.getDriver().findElement(By.xpath(locator)).findElement(By.xpath(secondLocator)).getText();
    }
